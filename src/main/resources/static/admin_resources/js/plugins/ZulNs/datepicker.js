...
function Datepicker(isHijr,year,month,firstDay,lang,theme,width){
	...
	updHeader=function(){
		...
		monthValElm.innerHTML=dispDate.getMonthStringName()
	},
...
Date.prototype.getDateString=function(){
	...
	return Datepicker.getDigit(this.getYearString().trim()+'-'+this.getMonthName()+'-'+date)
};
Date.prototype.getMonthName=function(m){
	m=(HijriDate.int(m,this.getMonth())%12+12)%12;
	return Datepicker.getVal('monthNames')[m]
};
Date.prototype.getMonthStringName=function(m){
	m=(HijriDate.int(m,this.getMonth())%12+12)%12;
	return Datepicker.getVal('monthStringNames')[m]
};
...
HijriDate.prototype.getMonthStringName=function(m){
	m=(HijriDate.int(m,this.getMonth())%12+12)%12;
	let p=Datepicker;
	return p.lang=='en'?HijriDate.monthStringNames[m]:p.getVal('hMonthNames')[m]
};
...
Datepicker.language={en:{
	...
	hEraSuffix:[""],
	//hEraSuffix:["H","BH"],
	monthStringNames:["January","February","March","April","May","June","July","August","September","October","November","December"],
