...
(function (l) {
    ...
    function ma(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "لايوجد بيانات متاحة" === b.sEmptyTable && X(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && d && "جار التحميل..." === b.sLoadingRecords &&
    ...
    var S = function (a, b, c) {
            a[b] !== q && (a[c] = a[b])
        }, Fa = /\[.*?\]$/, sa = /\(\)$/, na = u.util.get, ha = u.util.set, jb = u.util.escapeRegex, Qa = l("<div>")[0],
        sc = Qa.textContent !== q, tc = /<.*?>/g, hb = u.util.throttle, nc = [], N = Array.prototype,
        wc = function (a) {
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "لايوجد بيانات متاحة",
            sInfo: "Showing _START_ to _END_ of _TOTAL_ entries",
            sInfoEmpty: "عرض 0 من 0 إلى 0 صفوف",
